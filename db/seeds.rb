User.create!([
  ...
  { summoner_name: "Eisha", email: "eisha@gmail.com", password_digest: "$2a$12$uePf1ADN0oSKhiFh6vOQqeF0HAgeHY/Mz/FMvfQr8gWs8p67yyKBq", region: "NA", bio: "interestinger bio" },
])
Team.create!([
...
Membership.create!([
  ...
  { user_id: 6, team_id: 2, primary_role: "mid", secondary_role: "top", fill: true, assigned_role: nil },
  { user_id: 5, team_id: 2, primary_role: "top", secondary_role: "jung", fill: true, assigned_role: nil },
  { user_id: 4, team_id: 2, primary_role: "jung", secondary_role: "top", fill: true, assigned_role: nil },
  { user_id: 3, team_id: 2, primary_role: "adc", secondary_role: "supp", fill: true, assigned_role: nil },
  { user_id: 2, team_id: 2, primary_role: "supp", secondary_role: "adc", fill: true, assigned_role: nil },
])
